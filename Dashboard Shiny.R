  ...
  navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
             ...
             tabPanel("Análise geográfica",
                      div(class="outer",
                          ...
                          absolutePanel(id = "controls", class = "panel panel-default",
                                        ...
                                        selectInput("var",
                                                      "Var:",
                                                      label = h4("Selecione a variável:"),
                                                           choices = variaveis),
                                        
                                        selectInput("est", h4("Selecione a(s) estação(ões) meteorológica(s)"), cidades_mod$Cidade_Estado, multiple = TRUE),
                                        
                                        # Op1
                                        selectInput("ano", h4("Op1: Selecione o(s) ano(s):"), ano, multiple = TRUE),
                                      
                                        # Op 2
                                        sliderInput("slider2", label = h4("Op2: Selecione o intervalo de tempo"), min = 2002, 
                                             max = 2022, value = c(2010,2016)),
                                        
                                        # Op 3
                                        dateRangeInput("dates", label = h4("Op3: Selecione o intervalo de tempo")),
             ...
             tabPanel("Análise temporal",
                      div(class="outer",
                          ...
                          column(2, offset = 3,
                                 mainPanel(
                                   plotlyOutput("graph_analise_temporal"))))
             ),
             ...
             tabPanel("Modelagem preditiva",
                      div(class="outer",
                          ...
                          absolutePanel(id = "controls", class = "panel panel-default",
                                        ...
                                        selectInput("modelo",
                                                    "Modelo:",
                                                    label = h4("Selecione o modelo:"),
                                                    choices = c("ARMA", "ARIMA", "SARIMA")),
                                        tags$div(id="cite",
                                                 h6('Dados retirados do portal INMET.'))),
                          column(2, offset = 3,
                                 mainPanel(
             ...
             tabPanel("Relações entre regiões"
                      ...
                      div(class="outer",
                          ...
                          absolutePanel(id = "controls", class = "panel panel-default",
                                        top = 500, left = 55, width = 1200, fixed=TRUE,
             ...
             tabPanel("Dados"
                      ,
                      numericInput("maxrows", "Linhas a serem exibidas", 25),
                      verbatimTextOutput("rawtable"),
                      downloadButton("downloadCsv", "Download CSV"),tags$br(),tags$br()
             ),
